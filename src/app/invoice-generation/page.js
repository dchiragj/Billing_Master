...
const InvoiceMaster = () => {
  ...
  const handleAddSubmit = async (e) => {
    e.preventDefault();
    const payload = {...formData, CompanyCode : userDetail.CompanyCode, Finyear : Finyear,BillNO: "1",}
    console.log(payload);
  ...
  return (
    <div className={`p-8 w-full lg:w-[calc(100vw-388px)] ml-0 lg:ml-[288px] text-black min-h-screen`}>
      <button
        ...
        <form onSubmit={handleAddSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              ["PriceType", "Price Type", "select", false, dropdownData.PriceType],
              ["TaxType", "Tax Type", "select", false, dropdownData.TaxType],
                  ...
                  <tr key={index} className="border border-gray-300">
                    ...
                    {[
                      ...
                      <td key={i} className="p-2 border border-gray-300">
                        ...
                        />
                        {/* {["CHG1", "CHG2", "CHG3", "CHG4", "CHG5"].includes(field) &&
                        <input
                        type={["QTY", "DelQty", "NetPrice", "CHG1", "CHG2", "CHG3", "CHG4", "CHG5", "NetAmt"].includes(field) ? "number" : "text"}
                        name={field}
                        value={Bill[field] || ""}
                        onChange={(e) => handleInputChange(e, "Invdet", index)}
                        className="p-1 w-full mt-1 bg-gray-100 dark:bg-gray-700 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none text-center"
                      />
                       } */}
                      </td>
                    ))}
