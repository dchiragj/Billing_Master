    ...
    <div key={index} className="flex items-center">
      ...
      {type === "select" ? (
        ...
        <input
          type={type}
          name={name}
          value={name === "MRSCASH" ? formData.MRHDR["NETAMT"] || "" : formData.MRHDR[name] || ""}
          onChange={(e) => {
            // For NETAMT, update both fields
            if (name === "NETAMT") {
              const newEvent = {
                ...e,
                target: {
              ...
              handleInputChange(e, "MRHDR");
              handleInputChange(newEvent, "MRHDR");
            } else {
              handleInputChange(e, "MRHDR");
            }
          }}
          ...
          readOnly={name === "MRSCASH"} // Prevent direct editing of MRSCASH
        />
      )}
    </div>
  ))}
