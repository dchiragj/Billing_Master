...
// import { getBillEntryPayment } from "@/lib/masterService";
// import { useAuth } from "../context/AuthContext";
...
const BillPaymentDetails = () => {
  ...
  const filteredData = billDetails.map((bill, index) => ({
    ...
    // "Payment Gateway Charges(-)(-)": bill.paymentGatewayCharges || "-",
    // "COD Charges(-)(-)": bill.codCharges || "-",
    // "Discount(-)(-)": bill.discount || "-",
    // "Balance Amount": bill.balanceAmount || "-",
    // "Net Recd. Amount": bill.netReceivedAmount || "-",
    // "Tracking No": bill.trackingNo || "-",
