  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col h-full max-h-full">
          <div>
            <p className="text-center font-bold text-2xl py-5 text-black border-b-2">
              Billing Master
            </p>
          </div>
          ...
          <nav className="h-full overflow-y-auto">
            <div className="w-full flex h-full flex-col justify-between py-10">
              ...
              <Link href="/login">
                <button
                  onClick={logout}
                  className="flex items-center gap-3 ps-10 py-4 w-full text-lg rounded-xl text-black bg-white transition duration-200 ease-in-out hover:bg-[#E2E7F1]"
                >
                  <FontAwesomeIcon icon={faRightFromBracket} />
                  <span className="font-semibold">Logout</span>
                </button>
